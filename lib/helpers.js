...
exports.getPermissions = (user, corePermissions) => {
    return {
        ...
        show_unpublished_event: {
            agora: hasPermission(corePermissions, 'global:show_unpublished:agora'),
            epm: hasPermission(corePermissions, 'global:show_unpublished:epm'),
            spm: hasPermission(corePermissions, 'global:show_unpublished:spm')
        },
        edit_pax_limits: {
            agora: hasPermission(corePermissions, 'manage_event:agora'),
            epm: hasPermission(corePermissions, 'manage_event:epm'),
