...
exports.getEventPermissions = (data) => {
    ...
    permissions.edit_incoming_questions = permissions.edit_event || permissions.manage_incoming;
...
exports.getApplicationPermissions = ({ permissions, corePermissions, event, mine, application }) => {
    ...
    permissions.edit_incoming = mine || isIncoming;
...
exports.getIncomingPermissions = ({ permissions, corePermissions, event, mine }) => {
    const canManage = hasPermission(corePermissions, 'manage_applications:' + event.type);
    const isIncoming = hasPermission(corePermissions, 'manage_incoming:' + event.type);

    permissions.see_incoming = mine || canManage || isIncoming;

    permissions.edit_incoming = mine || canManage;
