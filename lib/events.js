...
exports.listEvents = async (req, res) => {
    if (req.query.all) {
        if (!req.permissions.show_unpublished_event.agora) {
            return errors.makeForbiddenError(res, 'Permission global:show_unpublished:agora is required, but not present.');
        }
    }
