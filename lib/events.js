...
exports.listEvents = async (req, res) => {
    if (req.query.all) {
        if (!req.permissions.show_unpublished_event.agora || !req.permissions.show_unpublished_event.spm || !req.permissions.show_unpublished_event.epm) {
            return errors.makeForbiddenError(res, 'Permission global:show_unpublished is required, but not present.');
        }
    }
