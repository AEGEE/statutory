...
const MembersAmountRouter = router({ mergeParams: true });
...
MembersAmountRouter.use(middlewares.authenticateUser, middlewares.ensureAuthorized);
MembersAmountRouter.get('/', memberslists.getMemberslistAmounts);
...
server.use('/members/:body_id', MembersAmountRouter);
