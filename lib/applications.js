...
exports.updateApplicationIncoming = async (req, res) => {
    if (!req.permissions.edit_incoming) {
        return errors.makeForbiddenError(res, 'You are not allowed to edit the application through the incoming form.');
    }
