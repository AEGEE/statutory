...
exports.updateApplication = async (req, res) => {
    ...
    // TODO: this should preferably not be stored in database but fetched from core.getMember()
...
exports.postApplication = async (req, res) => {
    ...
    // TODO: this should be fetched from core.getMember() and preferably not stored in database
...
exports.exportOpenslides = async (req, res) => {
    ...
    const exportString = headers.map(wrap).join(',') + '\n' + applications.map((application) => {
        ...
        return [
            ...
            0, // Is committee
            password,
            // TODO: fetch this from core.getMember()
...
exports.exportDelegatesJc = async (req, res) => {
    ...
    const exportString = await Promise.all(applications.map(async (application) => {
        ...
        return [
            ...
            user.email, // TODO: check with JC which email address this should be, since this is also the email they use for logging in
            application.first_name,
            application.last_name,
            body.code,
            application.participant_type
